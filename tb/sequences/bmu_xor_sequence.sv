class bmu_xor_sequence extends bmu_base_sequence;
    ...
    virtual task body();
        ...
        `uvm_info(
            get_type_name(),
            $sformatf(
                "XOR sequence finished: 7 directed, %0d random, 1 AP conflict, 1 CSR conflict",
                rand_iterations
            ),
            UVM_MEDIUM
        )
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // XOR + AP conflict case
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    task send_xor_ap_conflict();
        ...
        `uvm_info(
            get_type_name(),
            $sformatf(
                "XOR + AP CONFLICT: lxor=1 srl=1 A=0x%08h B=0x%08h",
                req.a_in,
                req.b_in
            ),
            UVM_MEDIUM
