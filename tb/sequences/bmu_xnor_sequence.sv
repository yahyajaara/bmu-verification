class bmu_xnor_sequence extends bmu_base_sequence;
    ...
    virtual task body();
        ...
        `uvm_info(
            get_type_name(),
            $sformatf(
                "XNOR sequence finished: 7 directed, %0d random, 1 AP conflict, 1 CSR conflict",
                rand_iterations
            ),
            UVM_MEDIUM
        )
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // XNOR + AP conflict case
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    task send_xnor_ap_conflict();

        bmu_sequence_item req;

        req = bmu_sequence_item::type_id::create(
            "xnor_ap_conflict_req"
        );
        ...
        `uvm_info(
            get_type_name(),
            $sformatf(
                "XNOR + AP CONFLICT: lxor=1 zbb=1 srl=1 A=0x%08h B=0x%08h",
                req.a_in,
                req.b_in
            ),
            UVM_MEDIUM
